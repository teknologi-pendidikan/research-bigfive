export default {
  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', name: 'og:url', content: 'https://bigfive.riset.teknologipendidikan.or.id' },
      { hid: 'og:image', name: 'og:image', content: 'https://bigfive.riset.teknologipendidikan.or.id/icon.png' },
      ...
      { hid: 'twitter:image', name: 'twitter:image', content: 'https://bigfive.riset.teknologipendidikan.or.id/icon.png' },
  ...
  */
  ...
  env: {
    API_URL: 'https://api-riset-um.vercel.app/api/' // TODO: Fix for dev environment
  },
  build: {
    extractCSS: true,
    extend (config, ctx) {
